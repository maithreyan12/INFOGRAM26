...
function EventsPage() {
        ...
        "EventsPage.useEffect": ()=>{
            const fetchEvents = {
                "EventsPage.useEffect.fetchEvents": async ()=>{
                    try {
                        const initialList = demoEvents.map({
                            "EventsPage.useEffect.fetchEvents.initialList": (demo)=>{
                                const normDemoSlug = demo.slug.toLowerCase().replace(/[^a-z0-9]/g, '');
                                const storeMatch = storeEvents.find({
                                    "EventsPage.useEffect.fetchEvents.initialList.storeMatch": (s)=>s.slug.toLowerCase().replace(/[^a-z0-9]/g, '') === normDemoSlug || s.id === demo.id
                                }["EventsPage.useEffect.fetchEvents.initialList.storeMatch"]);
                                if (storeMatch) {
                                    return {
                                        ...demo,
                        ...
                        }["EventsPage.useEffect.fetchEvents.initialList"]);
                        ...
                        const isTest = {
                            "EventsPage.useEffect.fetchEvents.isTest": (item)=>{
                                ...
                                return name === 'participant' || name.includes('participant') || email.includes('test') || email.includes('verification') || appId.includes('98035') || appId.includes('9999') || appId.includes('test');
                            }
                        }["EventsPage.useEffect.fetchEvents.isTest"];
                        ...
                        storeRegs.forEach({
                            "EventsPage.useEffect.fetchEvents": (r)=>{
                        ...
                        try {
                            ...
                            if (spRegs) {
                                spRegs.forEach({
                                    "EventsPage.useEffect.fetchEvents": (sr)=>{
                                        if (isTest(sr)) return;
                                        const exists = allPaidRecords.some({
                                            "EventsPage.useEffect.fetchEvents.exists": (r)=>r.applicantId === sr.applicant_id || sr.email && r.email === sr.email
                                        }["EventsPage.useEffect.fetchEvents.exists"]);
                                        if (!exists) {
                                            allPaidRecords.push({
                        ...
                        try {
                            if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"] && __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isFirebaseConfigured"]) {
                                ...
                                regSnap.docs.forEach({
                                    "EventsPage.useEffect.fetchEvents": (doc)=>{
                                        const data = doc.data();
                                        if ((data.status === 'paid' || data.paidAt || data.razorpayPaymentId) && !isTest(data)) {
                                            const exists = allPaidRecords.some({
                                                "EventsPage.useEffect.fetchEvents.exists": (r)=>r.applicantId === data.applicantId || data.email && r.email === data.email
                                            }["EventsPage.useEffect.fetchEvents.exists"]);
                                            if (!exists) {
                                                allPaidRecords.push({
                                ...
                                const tktSnap = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getDocs"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$common$2d$DugxmK6F$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__aR__as__collection$3e$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], 'tickets'));
                                tktSnap.docs.forEach({
                                    "EventsPage.useEffect.fetchEvents": (doc)=>{
                                        const data = doc.data();
                        ...
                        if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"] && __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isFirebaseConfigured"]) {
                            try {
                                ...
                                snapshot = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getDocs"])(eventsRef);
                            } catch  {}
                        }
                        const eventsData = initialList.map({
                            "EventsPage.useEffect.fetchEvents.eventsData": (localEv)=>{
                                const liveCount = allPaidRecords.filter({
                                    "EventsPage.useEffect.fetchEvents.eventsData": (rec)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$eventsData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isEventMatch"])(rec, localEv)
                                }["EventsPage.useEffect.fetchEvents.eventsData"]).length;
                                let dbData = null;
                                ...
                                if (!snapshot.empty) {
                                    ...
                                    const firestoreMatch = snapshot.docs.find({
                                        "EventsPage.useEffect.fetchEvents.eventsData.firestoreMatch": (doc)=>{
                                            const d = doc.data();
                                            const dNorm = (d.slug || d.name || '').toLowerCase().replace(/[^a-z0-9]/g, '');
                                            return dNorm === normLocalSlug || dNorm === normLocalName || doc.id === localEv.id;
                                        }
                                    }["EventsPage.useEffect.fetchEvents.eventsData.firestoreMatch"]);
                                    if (firestoreMatch) {
                                        dbData = firestoreMatch.data();
                        ...
                        }["EventsPage.useEffect.fetchEvents.eventsData"]);
    ...
    const filteredEvents = events.filter((event)=>{
        const matchesTab = activeTab === 'All' || activeTab === 'Technical' && event.category === 'technical' || activeTab === 'Non-Technical' && event.category === 'non-technical';
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$layout$2f$PublicLayout$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: `min-h-screen pb-20 ${isDark ? 'text-white' : 'text-slate-900'}`,
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                    className: "relative pt-28 pb-12 flex flex-col items-center justify-center overflow-hidden",
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "container-xl relative z-10 text-center px-4",
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                    className: `text-4xl sm:text-6xl md:text-7xl font-black tracking-tight mb-4 uppercase ${isDark ? 'text-white' : 'text-slate-900'}`,
                                    style: {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: `text-base sm:text-xl max-w-2xl mx-auto font-bold ${isDark ? 'text-slate-300' : 'text-slate-700'}`,
                                    children: "Discover the perfect challenge for your skills from our wide range of technical and non-technical events."
                                }, void 0, false, {
                                    fileName: "[project]/src/app/events/page.tsx",
                                    lineNumber: 220,
                                    columnNumber: 15
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                    className: "container-xl px-4 mb-10",
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: `flex flex-col md:flex-row justify-between items-center gap-5 p-4 sm:p-5 rounded-3xl border transition-colors duration-300 ${isDark ? 'bg-slate-900/90 border-purple-500/30 shadow-2xl backdrop-blur-2xl' : 'bg-white/95 border-slate-200 shadow-xl backdrop-blur-2xl'}`,
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: `flex space-x-2 p-1.5 rounded-2xl w-full md:w-auto overflow-x-auto border ${isDark ? 'bg-slate-950/80 border-slate-800' : 'bg-slate-100 border-slate-300'}`,
                                children: [
                                    'All',
                                    'Technical',
                                    'Non-Technical'
                                        ...
                                        className: `px-6 py-2.5 rounded-xl text-xs font-black uppercase tracking-wider transition-all whitespace-nowrap ${activeTab === tab ? isDark ? 'bg-gradient-to-r from-purple-600 to-indigo-600 text-white shadow-lg' : 'bg-gradient-to-r from-[#7c3aed] to-[#6366f1] text-white shadow-md' : isDark ? 'text-slate-300 hover:text-white hover:bg-slate-800' : 'text-slate-700 hover:text-slate-900 hover:bg-white/80 font-bold'}`,
                                        style: {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$search$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Search$3e$__["Search"], {
                                            className: `h-4 w-4 ${isDark ? 'text-amber-300' : 'text-[#7c3aed]'}`
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/events/page.tsx",
                                            lineNumber: 259,
                                            columnNumber: 17
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                        ...
                                        className: `w-full rounded-2xl pl-11 pr-4 py-2.5 text-xs font-bold transition-all border ${isDark ? 'bg-slate-950/90 border-slate-700 text-white placeholder-slate-400 focus:outline-none focus:border-amber-400' : 'bg-slate-50 border-slate-300 text-slate-900 placeholder-slate-500 focus:bg-white focus:outline-none focus:border-[#7c3aed] shadow-xs'}`
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/events/page.tsx",
                                        lineNumber: 261,
                                        columnNumber: 15
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: `mb-6 text-sm font-black uppercase tracking-wider ${isDark ? 'text-amber-300' : 'text-slate-800'}`,
                            children: [
                        ...
                        loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "w-10 h-10 border-4 border-[#7c3aed]/20 border-t-[#7c3aed] rounded-full animate-spin"
                            }, void 0, false, {
                                fileName: "[project]/src/app/events/page.tsx",
                                lineNumber: 284,
                                columnNumber: 15
                            ...
                            children: filteredEvents.map((event, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$events$2f$EventCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                        event: event
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/events/page.tsx",
                                        lineNumber: 295,
...
_s(EventsPage, "vSTYYO8cpdxCqa/jF8caEaefI28=", false, function() {
    return [
...
function EventCard({ event }) {
    ...
    const statusColor = event.status === 'live' ? 'text-red-600 dark:text-red-400 border-red-500/40 bg-red-500/10' : event.status === 'completed' ? isDark ? 'text-slate-400 border-slate-700 bg-slate-800/50' : 'text-slate-600 border-slate-300 bg-slate-100' : isDark ? 'text-cyan-300 border-cyan-500/40 bg-cyan-500/10' : 'text-cyan-800 border-cyan-300 bg-cyan-50 font-bold';
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
        whileTap: {
            scale: 0.97
        },
        ...
        className: "h-full",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: `rounded-3xl overflow-hidden flex flex-col h-full border transition-all duration-300 ${isDark ? 'bg-slate-900/90 border-purple-500/30 text-white shadow-2xl hover:border-purple-400/50 backdrop-blur-2xl' : 'bg-white/95 border-slate-200 text-slate-900 shadow-xl hover:border-[#7c3aed]/40 backdrop-blur-2xl'}`,
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: `h-32 sm:h-36 relative flex-shrink-0 ${event.bannerUrl ? 'bg-cover bg-center' : isTechnical ? 'bg-gradient-to-br from-indigo-700 via-purple-700 to-sky-700' : 'bg-gradient-to-br from-purple-700 via-fuchsia-700 to-pink-700'}`,
                    style: event.bannerUrl ? {
                        backgroundImage: `url('${event.bannerUrl}')`
                    } : {},
                    children: [
                        event.bannerUrl && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: `text-[11px] font-black uppercase tracking-widest px-3 py-1 rounded-full border backdrop-blur-md shadow-sm ${isTechnical ? 'bg-sky-500/20 text-white border-sky-400/40' : 'bg-purple-500/20 text-white border-purple-400/40'}`,
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "p-6 flex-grow flex flex-col gap-3",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "flex flex-wrap items-center justify-between gap-2",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                    className: `font-black text-lg sm:text-xl leading-snug ${isDark ? 'text-white' : 'text-slate-900'}`,
                                    children: event.name
                                }, void 0, false, {
                                    fileName: "[project]/src/components/events/EventCard.tsx",
                                    lineNumber: 85,
                                ...
                                (event.slug === 'flavour-fusion' || event.id === 'nontech-6' || event.name.toLowerCase().includes('flavour')) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    className: "text-[10px] font-black uppercase tracking-wider px-2.5 py-0.5 rounded-full bg-pink-500/20 text-pink-400 border border-pink-500/30 flex items-center gap-1 shadow-sm",
                                    children: "🎀 Girls Only"
                                }, void 0, false, {
                                    fileName: "[project]/src/components/events/EventCard.tsx",
                                    lineNumber: 91,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            className: `text-sm leading-relaxed line-clamp-2 flex-grow font-semibold ${isDark ? 'text-slate-300' : 'text-slate-700'}`,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "flex flex-col gap-2 mt-2 pt-3 border-t border-slate-200/40 dark:border-slate-800",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: `flex items-center gap-2.5 text-xs font-bold ${isDark ? 'text-slate-300' : 'text-slate-800'}`,
                                    children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "flex items-center justify-between mt-2 pt-2 border-t border-slate-200/40 dark:border-slate-800",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "flex items-center font-black text-amber-500 text-base",
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    children: event.registrationFee
                                                }, void 0, false, {
                                                    fileName: "[project]/src/components/events/EventCard.tsx",
                                                    lineNumber: 122,
                                                    columnNumber: 17
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: `text-[11px] font-black uppercase tracking-wider px-2 py-0.5 rounded-md ${isDark ? 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/20' : 'bg-emerald-50 text-emerald-700 border border-emerald-200'}`,
                                            children: seatsLeft > 0 ? `⚡ ${seatsLeft} / ${totalSlots} Slots` : 'Registration Full'
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/events/EventCard.tsx",
                                            lineNumber: 124,
                                            columnNumber: 15
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                    ...
                                    className: `py-3 px-3 rounded-2xl text-xs font-black uppercase tracking-wider flex items-center justify-center gap-1 transition-all duration-200 border ${isDark ? 'border-purple-500/30 text-purple-300 hover:bg-purple-500/10' : 'border-slate-300 text-slate-700 hover:bg-slate-100'}`,
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        children: "Details"
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/events/EventCard.tsx",
                                ...
                                seatsLeft > 0 && event.status !== 'completed' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                    href: `/register?event=${event.slug}`,
                                    className: `py-3 px-3 rounded-2xl text-xs font-black uppercase tracking-wider flex items-center justify-center gap-1 transition-all duration-200 shadow-md ${isDark ? 'bg-gradient-to-r from-purple-600 to-indigo-600 text-white hover:brightness-110' : 'bg-gradient-to-r from-[#7c3aed] to-[#6366f1] text-white hover:brightness-110'}`,
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            children: "Register"
                                        }, void 0, false, {
                                    ...
                                    disabled: true,
                                    className: `py-3 px-3 rounded-2xl text-xs font-black uppercase tracking-wider flex items-center justify-center cursor-not-allowed border ${isDark ? 'bg-slate-800/50 border-slate-800 text-slate-500' : 'bg-slate-100 border-slate-200 text-slate-400'}`,
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        children: "Closed"
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/events/EventCard.tsx",
...
_s(EventCard, "JkSxfi8+JQlqgIgDOc3wQN+nVIw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$ThemeContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTheme"]
    ];
});
...
//# sourceMappingURL=src_0_-2_wn._.js.map