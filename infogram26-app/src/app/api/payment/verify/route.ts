        ...
        if (regSnap.exists()) {
          ...
          await setDoc(
            doc(db, 'tickets', ticketId),
            {
              ...
              college: regData.personalInfo?.college || regData.college || 'CAHCET',
              department: regData.personalInfo?.department || regData.department || 'Information Technology',
              year: regData.personalInfo?.year || regData.year || '1st',
              events: eventsList,
