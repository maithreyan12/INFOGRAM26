        ...
        <div className="section-padding container-xl mx-auto px-4">
          ...
          >
            <div className="w-full h-[400px] rounded-2xl overflow-hidden relative">
              <iframe
                title="C. Abdul Hakeem College of Engineering & Technology Map"
                src="https://maps.google.com/maps?q=C.+Abdul+Hakeem+College+of+Engineering+%26+Technology,+Melvisharam,+Ranipet,+Tamil+Nadu+632509&t=&z=15&ie=UTF8&iwloc=&output=embed"
                width="100%"
                height="100%"
                style={{ border: 0 }}
