...
export const OFFICIAL_EVENTS: Event[] = [
  ...
  },
  {
    ...
    name: 'Codestorm',
    category: 'technical',
    description: 'Two-round coding challenge testing speed, accuracy, and problem-solving skills across any programming language.',
    rules: [
      'Maximum of 2 members | ₹50 per head',
      'First round has 20 questions in 30 minutes.',
      'Second round: Coding. Participants should solve 5 questions in 1 hour using any language.',
  ...
  },
  {
    ...
    name: 'Artistry',
    category: 'non-technical',
    description: 'Fine art and creative illustration contest testing artistic skills and imagination.',
    rules: [
      'Maximum of 1 member | ₹50 per head',
  ...
  },
  {
    ...
    name: 'Flavour Fusion',
    category: 'non-technical',
    description: 'Culinary contest evaluated on food taste, presentation, area cleanliness, and number of dishes.',
    rules: [
      'Maximum of 4 members | ₹50 per head',
  ...
  },
  {
    ...
    name: 'Battle Verse',
    category: 'non-technical',
    description: 'Battle Royale gaming tournament with strict fair-play guidelines (Solo or Team up to 4).',
    rules: [
