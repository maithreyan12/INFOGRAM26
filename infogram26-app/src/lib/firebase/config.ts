...
function safeGetAuth() {
  try { return app ? getAuth(app) : null; } catch (e) { return null; }
}
function safeGetDb() {
...
export const auth = safeGetAuth() as any;
export const db = safeGetDb() as any;
export const storage = safeGetStorage() as any;
export default app;
