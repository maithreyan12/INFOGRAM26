...
"[project]/src/components/home/AnnouncementsSection.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
            ...
            async function fetchAnnouncements() {
                try {
                    ...
                    if (snapshot.empty) {
                        ...
                        setAnnouncements(snapshot.docs.map({
                            "AnnouncementsSection.useEffect.fetchAnnouncements": (doc)=>{
                                const data = doc.data();
                        ...
                        }["AnnouncementsSection.useEffect.fetchAnnouncements"]));
                    }
                } catch (error) {
                    setAnnouncements(DEMO_ANNOUNCEMENTS);
                }
...
_s(AnnouncementsSection, "MLdoeMpvfE/h4MWtwJbdCM8JQSU=");
        ...
        "FeaturedEvents.useEffect": ()=>{
            async function fetchEvents() {
                try {
                    ...
                    const q = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["query"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$common$2d$DugxmK6F$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__aR__as__collection$3e$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], 'events'), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["where"])('isFeatured', '==', true), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["limit"])(6));
                    const snapshot = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getDocs"])(q);
                    if (snapshot.empty) {
                        setEvents(DEMO_EVENTS);
                    } else {
                        const fetched = snapshot.docs.map({
                            "FeaturedEvents.useEffect.fetchEvents.fetched": (doc)=>({
                                    id: doc.id,
                                    ...doc.data()
                                })
                        }["FeaturedEvents.useEffect.fetchEvents.fetched"]);
                        setEvents(fetched);
                    }
                } catch (error) {
                    setEvents(DEMO_EVENTS);
...
_s(FeaturedEvents, "+npp09ZlhZYCuFMbAhFP+QaH6MU=");
_c = FeaturedEvents;
var _c;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GalleryPreview.useEffect": ()=>{
            async function fetchGallery() {
                try {
                    if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isFirebaseConfigured"] || !__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"]) return; // placeholders shown by default
                    const q = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["query"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$common$2d$DugxmK6F$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__aR__as__collection$3e$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], 'gallery'), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["where"])('isActive', '==', true), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["limit"])(8));
                    const snapshot = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getDocs"])(q);
                    if (!snapshot.empty) {
                        setImages(snapshot.docs.map({
                            "GalleryPreview.useEffect.fetchGallery": (doc)=>({
                                    id: doc.id,
                                    ...doc.data()
                                })
                        }["GalleryPreview.useEffect.fetchGallery"]));
                    }
                } catch (error) {}
            }
            fetchGallery();
...
_s(GalleryPreview, "ScKwoilS3xNJP1q5r1COmrAdDIM=");
_c = GalleryPreview;
var _c;
                ...
                try {
                    ...
                    if (snapshot.empty) {
                        ...
                        setSponsors(snapshot.docs.map({
                            "SponsorsSection.useEffect.fetchSponsors": (doc)=>({
                                    id: doc.id,
                                    ...doc.data()
                                })
                        }["SponsorsSection.useEffect.fetchSponsors"]));
                    }
                } catch (error) {
                    setSponsors(DEMO_SPONSORS);
                }
...
_s(SponsorsSection, "bXE0gO2B7N4mytm3We7J2yrKv98=");
_c = SponsorsSection;
var _c;
...
//# sourceMappingURL=src_1hi5714._.js.map